...
import FlagImg from "../../assets/countriesAssets/15.png";
...
export const CountryAus = () => {
  ...
  return (
    <>
      <div class="shadow-xl rounded-lg mx-20 mt-5 mb-5 bg-gradient-to-r from-blue-800 to-red-500 flex flex-col justify-center items-center">
        <img
          src={FlagImg}
          alt="Player"
