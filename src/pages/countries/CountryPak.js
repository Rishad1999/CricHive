...
import FlagImg from "../../assets/countriesAssets/20.jpg";
...
export const CountryPak = () => {
  ...
  return (
    <>
      <div class="shadow-xl rounded-lg mx-20 mt-5 mb-5 bg-gradient-to-r from-white to-green-500 flex flex-col justify-center items-center">
        <img
          src={FlagImg}
          alt="Player"
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4 text-right">Mohammad Hafeez</td>
              <td className="px-6 py-4 text-right">Haris Rauf</td>
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4 text-right">Babar Azam</td>
              <td className="px-6 py-4 text-right">Haris Rauf</td>
              {/* <td className="px-6 py-4 text-right">
            <a
              href="#"
            ...
            <tr className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4 text-right">3</td>
              <td className="px-6 py-4 text-right">Mohammad Rizwan</td>
              <td className="px-6 py-4 text-right">Haris Rauf</td>
              {/* <td className="px-6 py-4 text-right">
            <a
              href="#"
