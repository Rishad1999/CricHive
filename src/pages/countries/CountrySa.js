        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4 text-right">H E van der Dussen</td>
              <td className="px-6 py-4 text-right">L Ngidi</td>
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4 text-right">6</td>
              <td className="px-6 py-4 text-right">AK Markram</td>
              <td className="px-6 py-4 text-right">T Shamsi</td>
              {/* <td className="px-6 py-4 text-right">
            <a
              href="#"
              className="font-medium text-blue-600 dark:text-blue-500 hover:underline"
            ...
            <tr className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4 text-right">R R Rossouw</td>
              <td className="px-6 py-4 text-right">Kagiso Rabada</td>
              {/* <td className="px-6 py-4 text-right">
            <a
              href="#"
              className="font-medium text-blue-600 dark:text-blue-500 hover:underline"
