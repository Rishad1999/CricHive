...
=======
        {player1 && (
          <div className="mx-10 p-6">
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-gradient-to-r from-neutral-300 to-stone-400 rounded-xl shadow-lg m-5 mt-2 h-16">
                <div className="PlayerbarLeft">
>>>>>>> Stashed changes
                  <div className="PlayerbarItem">
                    <span className="PlayerbarTitle">{player1.name}</span>
...
>>>>>>> Stashed changes
              ...
              <div className="">
                <div className="">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="mt-8">
                      <div className="text-center m-5 mt-6">
                        {/* <span className="text-2xl font-medium #f1f5f9 p-3 rounded-lg">
                        PLAYER COMPARISON
                      </span> */}
              ...
              <div className="text-right flex flex-col">
                <div className="m-5">
                  <span className="p-3 bg-gradient-to-r #f1f5f9 rounded-lg shadow-xl ">
                    {player1.name}
                  </span>
                </div>
                <div className="m-5">
